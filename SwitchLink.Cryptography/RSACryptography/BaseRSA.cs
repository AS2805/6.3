...
namespace SwitchLink.Cryptography.RSACryptography
{
    public class BaseRSA
    {
        ...
        public  byte[] DecodePkcs8PrivateKey(String instr)
        {
        ...
        public  byte[] DecodePkcs8EncPrivateKey(String instr)
        {
        ...
        public  RSACryptoServiceProvider DecodeEncryptedPrivateKeyInfo(byte[] encpkcs8)
        {
            // encoded OID sequence for  PKCS #1 rsaEncryption szOID_RSA_RSA = "1.2.840.113549.1.1.1"
            // this byte[] includes the sequence byte and terminal encoded null 
